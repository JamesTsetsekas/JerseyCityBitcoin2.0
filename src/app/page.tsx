      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#252525] to-[#161616] text-white">
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16">
          ...
          <p className="text-2xl text-white/80">
            ...
            in meeting up to discuss, and learn more about bitcoin in the Jersey
            City, NJ area. You can be well versed or new, all are welcome.
          </p>
          ...
          <div className="w-full max-w-3xl mt-0 flex justify-center pl-12 pr-12">
            <Link
              ...
              href="/community"
            >
              <h3 className="text-2xl font-bold text-center">Community →</h3>
              <div className="text-lg text-center">
                Connect with our vibrant Jersey City Bitcoin community. Share ideas, collaborate on projects,
                and stay updated on local Bitcoin initiatives and discussions.
              </div>
            </Link>
          </div>
